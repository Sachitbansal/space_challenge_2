...
import 'package:space_challenge/screens/homepage.dart';
import 'package:space_challenge/screens/moons.dart';
import 'package:space_challenge/screens/stars.dart';
...
class DrawerInfo {
  ...
  DrawerInfo({required this.item, required this.icon, required this.press});
}

class Galary {
  final String link;

  Galary({required this.link});
}

List<Galary> stars_galary = [
  Galary(
      link:
      'https://astronomy.com/-/media/Images/News%20and%20Observing/News/2019/12/Jupiter_moons.jpg?mw=600'),
  Galary(
      link:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Europa-moon-with-margins.jpg/220px-Europa-moon-with-margins.jpg'),
  Galary(
      link:
      'https://science.nasa.gov/science-red/s3fs-public/mnt/medialibrary/1998/10/22/ast22oct98_2_resources/callisto_med.jpg'),
  Galary(
      link:
      'https://media.npr.org/assets/img/2017/10/16/titan-41d62a75c7b7376fe8ff872bb1deec3bc24a4a14-s1200-c85.webp'),
];


List<Galary> moon_galary = [
  Galary(
      link:
      'https://astronomy.com/-/media/Images/News%20and%20Observing/News/2019/12/Jupiter_moons.jpg?mw=600'),
  Galary(
...
List<Galary> GalaryLinks = [
  Galary(
      link:
          'https://www.planetguide.net/wp-content/uploads/2020/06/orion-constellation.webp'),
  Galary(
      link:
          'https://naturenoon.com/wp-content/uploads/2021/07/hercules_star_constellation-1-1024x820-1.png'),
  Galary(
      link:
          'https://d39460vivz6red.cloudfront.net/questions/S-BB-NCERT8-CH17-EX-Q12/images/1_1592316770004.jpeg'),
  Galary(
      link:
